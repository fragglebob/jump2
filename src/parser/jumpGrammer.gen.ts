...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "UtilFunctions$string$9", "symbols": [{"literal":"s"}, {"literal":"l"}, {"literal":"i"}, {"literal":"d"}, {"literal":"e"}, {"literal":"r"}], "postprocess": (d) => d.join('')},
    {"name": "UtilFunctions", "symbols": ["UtilFunctions$string$9", "_", "1Args"], "postprocess": (d) => ({ type: "func", name: "slider", args: d[2] })},
    {"name": "UtilFunctions$string$10", "symbols": [{"literal":"k"}, {"literal":"n"}, {"literal":"o"}, {"literal":"b"}], "postprocess": (d) => d.join('')},
    {"name": "UtilFunctions", "symbols": ["UtilFunctions$string$10", "_", "1Args"], "postprocess": (d) => ({ type: "func", name: "knob", args: d[2] })},
    {"name": "UtilFunctions$string$11", "symbols": [{"literal":"b"}, {"literal":"u"}, {"literal":"t"}, {"literal":"t"}, {"literal":"o"}, {"literal":"n"}], "postprocess": (d) => d.join('')},
    {"name": "UtilFunctions", "symbols": ["UtilFunctions$string$11", "_", "1Args"], "postprocess": (d) => ({ type: "func", name: "button", args: d[2] })},
    {"name": "UtilFunctions$string$12", "symbols": [{"literal":"a"}, {"literal":"x"}, {"literal":"i"}, {"literal":"s"}], "postprocess": (d) => d.join('')},
    {"name": "UtilFunctions", "symbols": ["UtilFunctions$string$12", "_", "1Args"], "postprocess": (d) => ({ type: "func", name: "axis", args: d[2] })},
    ...
    {"name": "WorldFunctions$string$3", "symbols": [{"literal":"p"}, {"literal":"u"}, {"literal":"s"}, {"literal":"h"}], "postprocess": (d) => d.join('')},
    {"name": "WorldFunctions", "symbols": ["WorldFunctions$string$3", "_", "0Args"], "postprocess": (d) => ({ type: "func", name: "pushMatrix", args: d[2] })},
    {"name": "WorldFunctions$string$4", "symbols": [{"literal":"p"}, {"literal":"o"}, {"literal":"p"}], "postprocess": (d) => d.join('')},
    {"name": "WorldFunctions", "symbols": ["WorldFunctions$string$4", "_", "0Args"], "postprocess": (d) => ({ type: "func", name: "popMatrix", args: d[2] })},
    {"name": "WorldFunctions$string$5", "symbols": [{"literal":"t"}, {"literal":"r"}, {"literal":"a"}, {"literal":"n"}, {"literal":"s"}, {"literal":"l"}, {"literal":"a"}, {"literal":"t"}, {"literal":"e"}], "postprocess": (d) => d.join('')},
    {"name": "WorldFunctions", "symbols": ["WorldFunctions$string$5", "_", "3Args"], "postprocess": (d) => ({ type: "func", name: "translate", args: d[2] })},
    {"name": "WorldFunctions$string$6", "symbols": [{"literal":"r"}, {"literal":"o"}, {"literal":"t"}, {"literal":"a"}, {"literal":"t"}, {"literal":"e"}, {"literal":"X"}], "postprocess": (d) => d.join('')},
    {"name": "WorldFunctions", "symbols": ["WorldFunctions$string$6", "_", "1Args"], "postprocess": (d) => ({ type: "func", name: "rotateX", args: d[2] })},
    {"name": "WorldFunctions$string$7", "symbols": [{"literal":"r"}, {"literal":"o"}, {"literal":"t"}, {"literal":"a"}, {"literal":"t"}, {"literal":"e"}, {"literal":"Y"}], "postprocess": (d) => d.join('')},
    {"name": "WorldFunctions", "symbols": ["WorldFunctions$string$7", "_", "1Args"], "postprocess": (d) => ({ type: "func", name: "rotateY", args: d[2] })},
    {"name": "WorldFunctions$string$8", "symbols": [{"literal":"r"}, {"literal":"o"}, {"literal":"t"}, {"literal":"a"}, {"literal":"t"}, {"literal":"e"}, {"literal":"Z"}], "postprocess": (d) => d.join('')},
    {"name": "WorldFunctions", "symbols": ["WorldFunctions$string$8", "_", "1Args"], "postprocess": (d) => ({ type: "func", name: "rotateZ", args: d[2] })},
    {"name": "WorldFunctions$string$9", "symbols": [{"literal":"s"}, {"literal":"c"}, {"literal":"a"}, {"literal":"l"}, {"literal":"e"}], "postprocess": (d) => d.join('')},
    {"name": "WorldFunctions", "symbols": ["WorldFunctions$string$9", "_", "NArgs"], "postprocess": (d) => ({ type: "func", name: "scale", args: d[2] })},
