...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "UtilFunctions", "symbols": [{"literal":"beat"}, "_", "0Args"], "postprocess": (d) => ({ type: "func", name: "beat", args: d[2] })},
    {"name": "UtilFunctions", "symbols": [{"literal":"bar"}, "_", "0Args"], "postprocess": (d) => ({ type: "func", name: "bar", args: d[2] })},
    {"name": "UtilFunctions", "symbols": [{"literal":"beat_progress"}, "_", "0Args"], "postprocess": (d) => ({ type: "func", name: "beat_progress", args: d[2] })},
    {"name": "UtilFunctions", "symbols": [{"literal":"bar_progress"}, "_", "0Args"], "postprocess": (d) => ({ type: "func", name: "bar_progress", args: d[2] })},
    {"name": "UtilFunctions", "symbols": [{"literal":"beat_raw"}, "_", "0Args"], "postprocess": (d) => ({ type: "func", name: "beat_raw", args: d[2] })},
