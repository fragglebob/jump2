...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "FXFunctions", "symbols": [{"literal":"fx_warp"}, "_", "Args"], "postprocess": (d) => ({ type: "func", name: "fx_warp", args: d[2] })},
    ...
    {"name": "WorldFunctions", "symbols": [{"literal":"rotateX"}, "_", "Args"], "postprocess": (d) => ({ type: "func", name: "rotateX", args: d[2] })},
    {"name": "WorldFunctions", "symbols": [{"literal":"rotateY"}, "_", "Args"], "postprocess": (d) => ({ type: "func", name: "rotateY", args: d[2] })},
    {"name": "WorldFunctions", "symbols": [{"literal":"rotateZ"}, "_", "Args"], "postprocess": (d) => ({ type: "func", name: "rotateZ", args: d[2] })},
    {"name": "WorldFunctions", "symbols": [{"literal":"scale"}, "_", "Args"], "postprocess": (d) => ({ type: "func", name: "scale", args: d[2] })},
    {"name": "ShapeFunctions", "symbols": [{"literal":"box"}, "_", "Args"], "postprocess": (d) => ({ type: "func", name: "box", args: d[2] })},
    {"name": "ShapeFunctions", "symbols": [{"literal":"ball"}, "_", "Args"], "postprocess": (d) => ({ type: "func", name: "ball", args: d[2] })},
    {"name": "StyleFunctions", "symbols": [{"literal":"rgb"}, "_", "Args"], "postprocess": (d) => ({ type: "func", name: "rgb", args: d[2] })},
    {"name": "StyleFunctions", "symbols": [{"literal":"rgba"}, "_", "Args"], "postprocess": (d) => ({ type: "func", name: "rgba", args: d[2] })},
    {"name": "StyleFunctions", "symbols": [{"literal":"hsl"}, "_", "Args"], "postprocess": (d) => ({ type: "func", name: "hsl", args: d[2] })},
    {"name": "StyleFunctions", "symbols": [{"literal":"hsla"}, "_", "Args"], "postprocess": (d) => ({ type: "func", name: "hsla", args: d[2] })},
